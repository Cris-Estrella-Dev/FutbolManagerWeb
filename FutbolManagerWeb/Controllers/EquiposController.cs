...
namespace FutbolManagerWeb.Controllers
{
    public class EquiposController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipoId,Nombre,Ciudad")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipoId,Nombre,Ciudad")] Equipo equipo)
        {
